                  ...
                  <div className='flex items-center w-full gap-2 md:w-3/4 md:gap-5'>
                    <div className='relative w-12 h-12 mobile:h-8 mobile:w-8'>
                      <img
                        ...
                        src={contractInfo?.freelancer?.avatarURL ? contractInfo?.freelancer?.avatarURL : '/assets/images/users/user-3.png'}
                      /> 
                    ...
                    <div className='flex flex-col gap-4'>
                      <div className='flex items-center gap-2'>
                        <h2 className='text-xl mobile:text-xs'>{contractInfo?.freelancer?.fullName}</h2>
