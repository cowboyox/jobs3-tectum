...
const Review = () => {
  ...
  const handleSubmitReview = async () => {
    try {
      ...
      await api.post(`/api/v1/review/create_review_freelancergig`, {
  ...
  return (
    <div className='relative p-0 sm:p-0 lg:mt-8 xl:mt-8'>
      <div
        className={
          showModal ? `rounded-xl bg-[#10191D] p-10 blur-xl` : `rounded-xl bg-[#10191D] p-10`
        }
      >
        <div className='rounded-br-2xl rounded-tr-2xl border-l-4 border-l-[#34E250] bg-[#1B272C] p-5'>
          <h1 className='mb-3 text-2xl font-semibold text-[#F5F5F5]'>Your order was completed.</h1>
          <p className='text-[16px] font-normal text-[#96B0BD]'>
            Based on your expectations, how would you rate the rate of this delivery?
          </p>
        </div>

        <div className='my-7 border-b-2 bg-[#1B272C]'></div>

        <div className='py-5'>
          <h1 className='mb-10 text-2xl font-semibold text-[#F5F5F5]'>
            Based on your expectations, how would you rate the rate of this delivery?
          </h1>
          <div className='flex items-center gap-8'>
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${value == 1 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {value == 1 ? (
                <svg
                  width='20'
              ...
              <p className='mt-3 text-[16px] font-bold text-[#F5F5F5]'>Poor</p>
            </div>
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${value == 2 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {value == 2 ? (
                <svg
                  width='20'
              ...
              <p className='mt-3 text-[16px] font-bold text-[#F5F5F5]'>Fair</p>
            </div>
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${value == 3 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {value == 3 ? (
                <svg
                  width='20'
              ...
              <p className='mt-3 text-[16px] font-bold text-[#F5F5F5]'>Good</p>
            </div>
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${value == 4 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {value == 4 ? (
                <svg
                  width='20'
              ...
              <p className='mt-3 text-[16px] font-bold text-[#F5F5F5]'>Very Good</p>
            </div>
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${value == 5 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {value == 5 ? (
                <svg
                  width='20'
              ...
              <p className='mt-3 text-[16px] font-bold text-[#F5F5F5]'>Exceptional</p>
            </div>
          </div>
        </div>
        ...
        <div className='py-5'>
          ...
          <div className='flex items-center gap-8'>
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Attention to details' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {attraction == 'Attention to details' ? (
                ...
                >
                  ...
                  <path
                    d='M6 13.0809L10.243 17.3239L18.727 8.83789'
                    stroke='#F5F5F5'
                    stroke-width='1.5'
                    stroke-linecap='round'
                    stroke-linejoin='round'
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Attention to details</p>
            </div>
            ...
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Data Depth' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Data Depth</p>
            </div>
            ...
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Professionalism' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Professionalism</p>
            </div>
          </div>
          <div className='mt-5 flex items-center gap-8'>
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Innovation' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Innovation</p>
            </div>
            ...
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Exceed Expectations' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Exceed Expectations</p>
            </div>
            ...
            <div
              ...
              className={`flex h-14 w-60 items-center gap-3 p-5 py-4 text-center ${attraction == 'Strategic thinking' ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              ...
              <p className='text-[16px] font-bold text-[#F5F5F5]'>Strategic thinking</p>
            </div>
          </div>
        </div>
        ...
        <div className='py-5'>
          <h1 className='mb-10 text-2xl font-semibold text-[#F5F5F5]'>
            How was it working with Devon miles?
          </h1>
          <div className='flex items-center gap-8'>
            <div
              onClick={() => {
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${feeling == 1 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {feeling == 1 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${feeling == 2 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {feeling == 2 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${feeling == 3 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {feeling == 3 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${feeling == 4 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {feeling == 4 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${feeling == 5 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {feeling == 5 ? (
                <svg
                  width='20'
        ...
        <div className='py-5'>
          <h1 className='mb-3 text-2xl font-semibold text-[#F5F5F5]'>
            Based on your expectations, how would you rate the value of this delivery
          </h1>
          <p className='mb-10 text-[16px] font-normal text-[#96B0BD]'>
            Based on your expectations, how would you rate the rate of this delivery?
          </p>
          <div className='flex items-center gap-8'>
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${rate == 1 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {rate == 1 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${rate == 2 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {rate == 2 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${rate == 3 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {rate == 3 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${rate == 4 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {rate == 4 ? (
                <svg
                  width='20'
            ...
            <div
              ...
              className={`flex h-24 w-40 cursor-pointer flex-col items-center px-6 py-4 text-center ${rate == 5 ? 'border-[#DC4F13]' : 'border-[#3E525B]'} rounded-xl border-[1px]`}
            >
              {rate == 5 ? (
                <svg
                  width='20'
        ...
        <div className='my-5 border-b-2 bg-[#1B272C]'></div>

        <div className='py-5'>
          <h1 className='mb-3 text-2xl font-semibold text-[#F5F5F5]'>Write your public review</h1>
          <p className='mb-10 text-[16px] font-normal text-[#96B0BD]'>
            Based on your expectations, how would you rate the rate of this delivery?
          </p>
          <div className='rounded-xl border-[1px] border-[#526872] p-5'>
            <div className='flex items-center gap-3 rounded-xl bg-[#1B272C] p-5'>
              <div className='flex items-center gap-3'>
                <img
                  className='aspect-square h-12 w-12 rounded-full object-cover mobile:h-8 mobile:w-8'
                  src={
                    userInfo?.avatarURL ? userInfo?.avatarURL : '/assets/images/users/user-1.png'
                  }
                />
                <p className='text-[16px] font-bold text-[#F5F5F5]'>{userInfo?.fullName}</p>
              </div>
              <div className='border-x-[1px] border-[#3E525B] px-3'>
                <p className='text-[16px] font-bold text-[#F5F5F5]'>${userInfo?.totalEarns || 0}</p>
              </div>
              <div className='flex items-center gap-1'>
                ...
                <p className='text-[14.2px] font-medium text-[#F5F5F5]'>(5)</p>
              </div>
            </div>
            ...
            <textarea
              ...
              rows={5}
              className='w-full bg-[#10191D] p-2 focus:outline-none'
            />
          </div>
        </div>

        <div className='py-5'>
          <div className='h-4 rounded-xl bg-[#1B272C]'></div>
          <p className='mt-5 text-[16px] font-normal text-[#96B0BD]'>
        ...
        <div className='flex items-center justify-end'>
          <button
            ...
            className='w-44 rounded-xl bg-[#DC4F13] p-4 text-[16px] font-bold text-[#F5F5F5]'
          >
            Send
          </button>
        </div>
