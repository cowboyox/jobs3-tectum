...
const Orders = () => {
	...
	return (
		<DashboardLayout header={{ title: "Gig Orders" }}>
			<div className="p-0 sm:p-0 xl:mt-8 lg:mt-8">
				...
				<div className="bg-[#10191D] mt-4 text-center p-5 rounded-xl">
					You have{" "}
					<span className="text-[#DC4F13] font-bold">49</span>{" "}
					Orders😊
				</div>
						...
						>
							...
							{isSmallScreen && (
								<div className="text-left text-[#96B0BD]">
									Creating intuitive and visually compelling
									digital interfaces. My mission is to bridge
									the gap between functionality and
									aesthetics, ensuring that every user
									interaction is as enjoyable as it is
									efficient.
								</div>
							)}
							<div className="mt-3 flex md:flex-row flex-col justify-between md:items-center items-start">
								...
								<div className="bg-[#1B272C] p-1 rounded-xl flex-none md:mt-0 mt-2">
									<button className="md:p-5 px-8 p-4">
										Message
									</button>
