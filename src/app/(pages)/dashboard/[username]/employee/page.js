          ...
          <div className='profile_left'>
            <div className='navigate_profile_tabs'>
              ...
              <div className='navigate_tabs_container'>
                <div
                  className={`single_nav_tab ${activeProfileTab === 'ui_ux' ? 'current_tab' : ''}`}
                  onClick={() => handleTabClick('ui_ux')}
                >
                  <span>UX/UI Design</span> <GoChevronRight />
                </div>
                <div
                  className={`single_nav_tab ${activeProfileTab === 'frontend' ? 'current_tab' : ''}`}
                  onClick={() => handleTabClick('frontend')}
                >
                  <span>Front-End Development</span> <GoChevronRight />
                </div>
                <div
                  className={`single_nav_tab ${activeProfileTab === 'all_work' ? 'current_tab' : ''}`}
            ...
            <div className='other_profile_details'>
              ...
              <div className='row_profile_details'>
                ...
                <p>
                  <span>Teamup Agency</span> 543 hours
                </p>
                <p>100% Job Success</p>
              </div>
            </div>
          ...
          <div className='profile_right'>
            {activeProfileTab === 'all_work' && (
              <div className='profile_tab_content'>
                ...
                <div className='profile_tab_description'>
                  <p>
                    Highly experienced and strong 7 years of experience in ui & ux design to help
                    you make a great wow factor and boost your customer satisfaction for your
                    website design, mobile design or Figma design.
                  </p>
                  <p>
                  ...
                  <p>
                    Also, I&apos;m the founder of an Indonesia-based design agency, where I lead a
                    team of talented Website designer, UX designers and Figma designer. I take a
                    flexible problem-solving approach to every project, and I&apos;m confident that
                    my experience and expertise can help us create a functional and visually
                    appealing design for your website or app.
                  </p>
                  <p>
                    ...
                    ✅ Prototyping <br />
                    ✅ UX Research <br />
                    ✅ Design system / Design tokens <br />✅ Design documentation
                  </p>
                  <p>
                    I always begin every project by working closely with clients to understand their
                    needs and brainstorm ideas. I then create a rough product requirements or
                    sitemap and craft high-fidelity designs that meet their unique needs.
                  </p>
                  <p>
                    My design tools: <br />
                  ...
                  <p>
                    Take a look at my Upwork profile and portfolio to see if I&apos;m the right fit
                    for your project. I&apos;m excited to hear more about your ideas and help bring
                    them to life. Don&apos;t hesitate to send me a job invitation and let&apos;s
                    chat!
                  </p>
                  <p>
                    ----- <br />
                    My specialities <br />
                    UI/UX Designer, Website designer, Mobile app designer, Figma designer, User
                    Interface, User Experience, Android designer, iOS designer, Professional
                    designer, Senior designer, Website redesign, Mobile app redesign, Dashboard
                    designer, Dashboard redesign, Responsive website designer, SaaS designer
                  </p>
                </div>
              </div>
            )}
            ...
            <div className='work_history'>
              <div className='work_history_top'>
                ...
                <nav>
                  <div
                    className={`review_tab_nav ${activeReviewTab === 'completed_jobs' ? 'current_reviews' : ''}`}
                    onClick={() => handleReviewTabClick('completed_jobs')}
                  >
                    Completed jobs (99)
                  </div>
                  <div
                    className={`review_tab_nav ${activeReviewTab === 'in_progress' ? 'current_reviews' : ''}`}
                    onClick={() => handleReviewTabClick('in_progress')}
                  >
                    In progress (10)
                  </div>
                </nav>
              ...
              <div className='single_project_catalog'>
                ...
                <div className='project_details'>
                  <h4 className='project_name'>
                    You will get a fantastic Landing page design in Figma
                  </h4>
                  <div className='project_time'>2 days delivery</div>
                  <Link className='view_project' href='#'>
                    View project
                  </Link>
                </div>
              </div>
