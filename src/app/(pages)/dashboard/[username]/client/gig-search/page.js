...
const DropdownItem = props => {
  return (
    <div className='flex gap-4 items-center p-0 cursor-pointer'>
      ...
      <label htmlFor={props.category_id} className='text-sm text-[#96B0BD] cursor-pointer'>
        {props.category_name}
      </label>
    </div>
  );
...
const GigSearch = () => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='flex gap-2  bg-[#10191d] rounded-xl'>
        ...
        <div className='flex items-center gap-3 cursor-pointer hover:bg-[#1B272C] rounded-xl transition mobile:hidden m-3'>
          <IoLocationOutline stroke='#96B0BD' size={20} />
          <span className='text-[#96B0BD]'>Anywhere</span>
        </div>
        {(!isSmallScreen || searchType === 'normal') && (
          <div className='flex items-center gap-3 cursor-pointer hover:bg-[#1B272C] rounded-xl transition m-3 mobile:m-1'>
      ...
      <div className='flex gap-3 mobile:flex-col'>
        <Popover>
          ...
          <PopoverContent
            align='start'
            className='px-6 py-4 bg-[#1B272C] flex flex-col gap-4 rounded-xl'
          >
      ...
      <GigCard />
      <GigCard /> */}
      <div className='py-5 md:text-xl hover:bg-white transition hover:text-black px-10 w-full max-w-full rounded-xl mobile:px-5 border border-[#aaaaaaaa] text-center mx-auto cursor-pointer mt-4'>
        Load more +
      </div>
    </div>
  );
