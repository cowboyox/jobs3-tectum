...
const FreelancerProfile = () => {
 ...
 let parsedToken = JSON.parse(tmp);
  ...
  const saveToDB = (tmp) => {
    api.put(`/api/v1/profile/update-profileinfo/${user.email}`, tmp).then(data => {
      return toast({
        variant: "default",
        title: <h1 className='text-center'>Success</h1>,
                    ...
                    <div className='flex flex-row justify-between'>
                      <div className="text-[#96B0BD] text-lg">Profile info</div>
                      {
                        ...
                        <div className='text-xl text-[#96B0BD]'>
                          {
                            isEditProfileInfo ?
                              <img src='/assets/images/icons/save.png' width={25} height={25} className="cursor-pointer" onClick={() => { saveProfile("profileInfo"); setEditProfileInfo(false); }} />
                              :
                    ...
                    <div className='flex flex-row justify-between'>
                      <p className="text-[#96B0BD] text-lg">Price</p>
                      {
                        ...
                        <div className='text-xl text-[#96B0BD]'>
                          {
                            isEditPrice ?
                              <img src='/assets/images/icons/save.png' width={25} height={25} className="cursor-pointer" onClick={() => { saveProfile("priceInfo"); setEditPrice(false); }} />
                              :
                    ...
                    <div className='flex flex-row justify-between'>
                      <p className="text-[#96B0BD] text-lg">Skills</p>
                      {
                        ...
                        <div className='text-xl text-[#96B0BD]'>
                          {
                            isEditSkills ?
                              <img src='/assets/images/icons/save.png' width={25} height={25} className="cursor-pointer" onClick={() => { saveProfile("skillsInfo"); setEditSkills(false); }} />
                              :
                    ...
                    <div className="flex flex-row justify-between">
                      <p className="text-[#96B0BD] text-lg">Languages</p>
                      {
                        ...
                        <div className='text-xl text-[#96B0BD]'>
                          {
                            isEditLang ?
                              <img src='/assets/images/icons/save.png' width={25} height={25} className="cursor-pointer" onClick={() => { saveProfile("languagesInfo"); setEditLang(false); }} />
                              :
