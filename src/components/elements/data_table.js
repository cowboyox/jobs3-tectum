  ...
  return (
    <div className='data_table'>
      <div className='table_head'>
        ...
        <div className='half_table'>
          {props.category_set == true && <div className='col_1 table_category'>Category</div>}
          {props.type_set == true && <div className='col_1 table_type'>Applications</div>}
            ...
            <div className='col_1 table_status'>
              <div className='button_dropdown'>
                ...
                <div className='button_dropdown_content'>
                  <div
                    className='dropdown_option choosen_option'
                    onClick={() => setSelectedStatusOption('all')}
                  >
                    All
                  </div>
                  <div
                    className='dropdown_option'
                    onClick={() => setSelectedStatusOption('active')}
                  >
                    Active
                  </div>
                  <div
                    className='dropdown_option'
                    onClick={() => setSelectedStatusOption('inactive')}
                  >
                    Inactive
                  </div>
                </div>
          ...
          <div className='table_row' key={single_data.id}>
            <div className='half_table'>
              <div className='col_1 content_name'>
                <div className={`copy_clypboard ${single_data.row_status}`}>
                  <IoClipboardOutline />
                </div>
