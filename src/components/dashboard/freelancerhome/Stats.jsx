    ...
    <div className="w-full min-h-96 flex flex-col -mt-10 font-roboto md:mt-10">
      ...
      <div className="mt-10 flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-2">
          <div className="w-full md:w-[70%] rounded-2xl bg-deepGreen min-h-96 h-full p-5 flex flex-col max-h-[45vh]">
            ...
            <div className="flex flex-col justify-between gap-2 flex-1 mt-6">
              {orders.length ? orders.map((spend, index) => (
                <div
                  key={index}
              ...
              <div className="text-center mt-[20%]">Not yet</div>  
            }
            </div>
          </div>
          <div className="w-full md:w-[30%] rounded-2xl bg-deepGreen min-h-96 h-full p-5 flex flex-col max-h-[45vh]">
            <div className="h-1/6 flex justify-between items-center">
            <h3 className="text-white text-2xl font-semibold">
                Earnings
              </h3>
            ...
            <div className="flex-1 mt-6">
              {earnings.length ? earnings.map((earning, index) => (
                <div
                  key={index}
              ...
              <div className="text-center mt-[50%]">Not yet</div>
            }
            </div>
          </div>
        </div>
