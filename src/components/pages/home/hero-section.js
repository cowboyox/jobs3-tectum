  ...
  return (
    ...
    >
      ...
      <div className='container'>
        ...
        <div
          className='relative z-20 flex gap-5 rounded-2xl bg-[#f5f5f50d] p-5 mobile:gap-3 mobile:p-2'
          id='search_bar'
        >
          <Select default='classic' id='search_options'>
            <SelectTrigger className='h-16 w-20 rounded-xl bg-[#1a272c] mobile:h-12'>
