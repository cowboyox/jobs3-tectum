      ...
      <div className="search_results_filter_container">
        <div className="filter_search_results">
                ...
                dataCategories.map((single_sector) => {
                  return (
                    <div className="filter_option" key={single_sector.id}>
                      ...
                      />
                      <label htmlFor={`category_${single_sector.id}`}>
                        {single_sector.name}
                      </label>
                    </div>
                  );
          ...
          <div className="filter_box">
            ...
            <div className="filter_options">
              <div className="filter_option">
                <input type="radio" id="job_type_fulltime" name="job_type" />
                <label htmlFor="job_type_fulltime">Full-Time</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="job_type_parttime" name="job_type" />
                <label htmlFor="job_type_parttime">Part-Time</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="job_type_contract" name="job_type" />
                <label htmlFor="job_type_contract">Contract</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="job_type_freelance" name="job_type" />
                <label htmlFor="job_type_freelance">Freelance</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="job_type_volunteer" name="job_type" />
                <label htmlFor="job_type_volunteer">Volunteer</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="job_type_internship" name="job_type" />
          ...
          <div className="filter_box">
            ...
            <div className="filter_options">
              <div className="filter_option">
                <input type="radio" id="date_last3days" name="date_posted" />
                <label htmlFor="date_last3days">Last 3 days</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="date_last24hours" name="date_posted" />
                <label htmlFor="date_last24hours">Last 24 hours</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="date_last7days" name="date_posted" />
                <label htmlFor="date_last7days">Last 7 days</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="date_last2weeks" name="date_posted" />
                <label htmlFor="date_last2weeks">Last 2 weeks</label>
              </div>
              <div className="filter_option">
                <input type="radio" id="date_lastmonth" name="date_posted" />
              ...
              <div className="search_results_top">
                ...
                {jobsNumber == 0 && (
                  <div className="sorry_message">
                    <p>
                      No Record Sorry! Does ot match record with your keyword.
                      Change your filter keyword to re-submit OR{" "}
                    </p>
                ...
                <div className="email_me_form">
                  ...
                  <form action="">
                    <div className="form_top">
                      <input type="text" placeholder="Job Alert Name..." />
                      <input type="email" placeholder="Email" />
                      <button type="submit">Create Alert</button>
                    </div>
                    <div className="form_checkboxes">
                      <div className="single_check">
                        <input type="checkbox" name="send_email" id="daily" />
                        <label htmlFor="daily">Daily</label>
                      </div>
                      <div className="single_check">
                        <input type="checkbox" name="send_email" id="weekly" />
                      ...
                      <div className="single_check">
                        <input type="checkbox" name="send_email" id="monthly" />
