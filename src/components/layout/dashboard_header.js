...
const DashboardHeader = () => {
  ...
  return (
    <header
      className='flex flex-wrap items-center mobile:flex-nowrap justify-between h-28 md:h-20 mobile:justify-center mobile:gap-3'
      id='header_container'
    >
      {renderPopup()}
      <div className='mobile:hidden'>
        <h1 className='text-3xl text-[#F5F5F5] font-bold'>{title}</h1>
      </div>
      <div className='flex items-center w-full gap-3 md:w-auto md:gap-4 mobile:justify-between'>
        <div className='p-3 rounded-[10px] bg-[#10191D] cursor-pointer md:hidden order-1' onClick={() => { OpenSideBar(); }}>
          <LuAlignLeft className='w-7 h-7 mr-auto fill-[#96B0BD] stroke-[#96B0BD]' /> 
        </div>
        <div className='flex items-center gap-2 mobile:hidden'>
          {renderWalletButton()}
        </div>
        <Select defaultValue={auth?.currentRole} onValueChange={handleChangeRole}>
          <SelectTrigger className='flex text-base font-normal w-auto min-w-20 gap-1 rounded-xl bg-[#10191D] py-5 mobile:py-6 mobile:order-3'>
            <SelectValue />
          </SelectTrigger>
          ...
          <DropdownMenuTrigger className='mobile:hidden'>
            <div className='cursor-pointer rounded-xl bg-[#10191D] p-[10px] mobile:hidden'>
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17 18.93H13L8.54999 21.89C7.88999 22.33 7 21.86 7 21.06V18.93C4 18.93 2 16.93 2 13.93V7.92993C2 4.92993 4 2.92993 7 2.92993H17C20 2.92993 22 4.92993 22 7.92993V13.93C22 16.93 20 18.93 17 18.93Z" stroke="#8599A5" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.9998 11.8599V11.6499C11.9998 10.9699 12.4198 10.6099 12.8398 10.3199C13.2498 10.0399 13.6598 9.6799 13.6598 9.0199C13.6598 8.0999 12.9198 7.35986 11.9998 7.35986C11.0798 7.35986 10.3398 8.0999 10.3398 9.0199" stroke="#8599A5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.9955 14.25H12.0045" stroke="#8599A5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            ...
            <DropdownMenuItem className='text-lg font-medium rounded cursor-pointer hover:bg-[#1B272C] py-3'>
              <div className='flex items-center gap-2'>
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M12 8V17" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M22 12.5C22 18.02 17.52 22.5 12 22.5C6.48 22.5 2 18.02 2 12.5C2 6.98 6.48 2.5 12 2.5" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M22 6.5V2.5H18" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M17 7.5L22 2.5" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <DropdownMenuItem className='text-lg font-medium rounded cursor-pointer hover:bg-[#1B272C] py-3'>
              <div className='flex items-center gap-2'>
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M16.5 22V18" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12.1596 11.37C12.0596 11.36 11.9396 11.36 11.8296 11.37C9.44961 11.29 7.55961 9.34 7.55961 6.94C7.54961 4.49 9.53961 2.5 11.9896 2.5C14.4396 2.5 16.4296 4.49 16.4296 6.94C16.4296 9.34 14.5296 11.29 12.1596 11.37Z" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M11.99 22.3099C10.17 22.3099 8.36004 21.8499 6.98004 20.9299C4.56004 19.3099 4.56004 16.6699 6.98004 15.0599C9.73004 13.2199 14.24 13.2199 16.99 15.0599" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <DropdownMenuItem className='text-lg font-medium rounded cursor-pointer hover:bg-[#1B272C] py-3' onClick={handleSignOut}>
              <div className='flex items-center gap-2'>
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M15.0001 12.5H3.62012" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M5.85 9.1499L2.5 12.4999L5.85 15.8499" stroke="#96B0BD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
