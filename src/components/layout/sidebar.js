  ...
  useEffect(() => {
    ...
    menu_links.forEach((single_link) => {
      single_link.addEventListener("click", () => {
        const menu_controls = document.querySelectorAll(
          ".main_sidebar .menu_control"
        );
        menu_links.forEach((will_remove_current) => {
          will_remove_current.classList.remove("current");
        });
        menu_controls.forEach((will_remove_current) => {
          will_remove_current.classList.remove("current");
        });
      ...
      >
        <div className="links_container">
          <div className="menu_item">
            <Link href="/dashboard/home" className="menu_control">
