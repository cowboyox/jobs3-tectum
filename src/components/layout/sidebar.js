...
const SideBar = () => {
  ...
  const freelancer_menu_data = [
    ...
    {
      href: `/dashboard/freelancer/profile/${auth?.currentProfile?._id}`,
      icon: (
        <svg
          fill='none'
          height='25'
    ...
    {
      href: `/dashboard/freelancer/portfolio/${auth?.currentProfile?._id}`,
      icon: (
        <svg
          fill='none'
          height='25'
  ...
  const client_menu_data = [
    ...
    {
      href: `/dashboard/client/profile/${auth?.currentProfile?._id}`,
      icon: (
        <svg
          fill='none'
          height='25'
